...
namespace RadioManager.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactResults :  IEquatable<ContactResults>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactResults" /> class.
        /// </summary>
        ...
        public ContactResults(long? CurrentPage = default(long?), long? From = default(long?), long? LastPage = default(long?), string NextPageUrl = default(string), string Path = default(string), long? PerPage = default(long?), string PrevPageUrl = default(string), long? To = default(long?), long? Total = default(long?), List<ContactResult> Results = default(List<ContactResult>))
        {
        ...
        {
            return this.Equals(input as ContactResults);
        }

        /// <summary>
        /// Returns true if ContactResults instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactResults input)
        {
            if (input == null)
                return false;
