...
namespace RadioManager.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TagRelationsBroadcasts :  IEquatable<TagRelationsBroadcasts>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagRelationsBroadcasts" /> class.
        /// </summary>
        /// <param name="href">href.</param>
        /// <param name="model">model.</param>
        /// <param name="operation">operation.</param>
        /// <param name="_params">_params.</param>
        public TagRelationsBroadcasts(string href = default(string), string model = default(string), string operation = default(string), TagRelationsBroadcastsParams _params = default(TagRelationsBroadcastsParams))
        {
            this.Href = href;
            this.Model = model;
