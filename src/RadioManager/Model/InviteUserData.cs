...
namespace RadioManager.Model
{
    ...
    public partial class InviteUserData :  IEquatable<InviteUserData>, IValidatableObject
    {
        ...
        public InviteUserData(string Email = default(string), long? RoleId = default(long?))
        {
            ...
            if (RoleId == null)
            {
                throw new InvalidDataException("RoleId is a required property for InviteUserData and cannot be null");
            }
            else
            {
                this.RoleId = RoleId;
