...
namespace RadioManager.Model
{
        ...
        public partial class InlineResponse20010 :  IEquatable<InlineResponse20010>, IValidatableObject
    {
        ...
        public InlineResponse20010(long? currentPage = default(long?), long? from = default(long?), long? lastPage = default(long?), string nextPageUrl = default(string), string path = default(string), long? perPage = default(long?), string prevPageUrl = default(string), long? to = default(long?), long? total = default(long?), List<PresenterResult> results = default(List<PresenterResult>))
        {
