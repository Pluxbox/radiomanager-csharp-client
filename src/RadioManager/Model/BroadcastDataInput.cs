...
namespace RadioManager.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BroadcastDataInput :  IEquatable<BroadcastDataInput>, IValidatableObject
    {
        /// <summary>
        ...
        public BroadcastDataInput(long? ProgramId = default(long?), long? ModelTypeId = default(long?), long? StationId = default(long?), BroadcastFieldValues FieldValues = default(BroadcastFieldValues), string Title = default(string), DateTime? Start = default(DateTime?), DateTime? Stop = default(DateTime?), long? GenreId = default(long?), string Description = default(string), string ShortName = default(string), string MediumName = default(string), string Website = default(string), string Email = default(string), bool? Recommended = default(bool?), string Language = default(string), bool? Published = default(bool?), string RepetitionUid = default(string), RepetitionTypeEnum? RepetitionType = default(RepetitionTypeEnum?), DateTime? RepetitionEnd = default(DateTime?), DateTime? RepetitionStart = default(DateTime?), List<bool?> RepetitionDays = default(List<bool?>), long? PtyCodeId = default(long?), List<int?> Tags = default(List<int?>), List<int?> Presenters = default(List<int?>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BroadcastDataInput);
        }

        /// <summary>
        /// Returns true if BroadcastDataInput instances are equal
        /// </summary>
        /// <param name="other">Instance of BroadcastDataInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BroadcastDataInput other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
