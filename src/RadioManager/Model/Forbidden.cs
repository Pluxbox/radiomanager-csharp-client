...
namespace RadioManager.Model
{
        ...
        public partial class Forbidden :  IEquatable<Forbidden>, IValidatableObject
    {
        ...
        public Forbidden(string error = default(string), long? statusCode = default(long?))
        {
            ...
            if (statusCode == null)
            {
                throw new InvalidDataException("statusCode is a required property for Forbidden and cannot be null");
            }
            else
            {
