...
namespace RadioManager.Model
{
        ...
        public partial class InlineResponse2007 :  IEquatable<InlineResponse2007>, IValidatableObject
    {
        ...
        public InlineResponse2007(long? currentPage = default(long?), long? from = default(long?), long? lastPage = default(long?), string nextPageUrl = default(string), string path = default(string), long? perPage = default(long?), string prevPageUrl = default(string), long? to = default(long?), long? total = default(long?), List<GroupResult> results = default(List<GroupResult>))
        {
