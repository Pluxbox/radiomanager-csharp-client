...
namespace RadioManager.Model
{
    ...
    public partial class PresenterDataInput :  IEquatable<PresenterDataInput>, IValidatableObject
    {
        ...
        public PresenterDataInput(long? ModelTypeId = default(long?), List<Object> FieldValues = default(List<Object>), string Firstname = default(string), string Lastname = default(string), bool? Active = default(bool?), string Name = default(string))
        {
