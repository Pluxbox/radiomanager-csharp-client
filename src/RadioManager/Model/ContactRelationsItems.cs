...
namespace RadioManager.Model
{
        ...
        public partial class ContactRelationsItems :  IEquatable<ContactRelationsItems>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ContactRelationsItems);
        }

        /// <summary>
        /// Returns true if ContactRelationsItems instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactRelationsItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactRelationsItems input)
        {
            if (input == null)
                return false;
