...
namespace RadioManager.Model
{
        ...
        public partial class InlineResponse2009 :  IEquatable<InlineResponse2009>, IValidatableObject
    {
        ...
        public InlineResponse2009(long? currentPage = default(long?), long? from = default(long?), long? lastPage = default(long?), string nextPageUrl = default(string), string path = default(string), long? perPage = default(long?), string prevPageUrl = default(string), long? to = default(long?), long? total = default(long?), List<ModelTypeResult> results = default(List<ModelTypeResult>))
        {
