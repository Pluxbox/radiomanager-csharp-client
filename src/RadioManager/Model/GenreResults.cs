...
namespace RadioManager.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GenreResults :  IEquatable<GenreResults>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GenreResults" /> class.
        /// </summary>
        ...
        public GenreResults(long? CurrentPage = default(long?), long? From = default(long?), long? LastPage = default(long?), string NextPageUrl = default(string), string Path = default(string), long? PerPage = default(long?), string PrevPageUrl = default(string), long? To = default(long?), long? Total = default(long?), List<GenreResult> Results = default(List<GenreResult>))
        {
        ...
        {
            return this.Equals(input as GenreResults);
        }

        /// <summary>
        /// Returns true if GenreResults instances are equal
        /// </summary>
        /// <param name="input">Instance of GenreResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenreResults input)
        {
            if (input == null)
                return false;
