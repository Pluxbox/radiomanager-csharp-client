...
namespace RadioManager.Model
{
    ...
    public partial class BroadcastResults :  IEquatable<BroadcastResults>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as BroadcastResults);
        }

        /// <summary>
        /// Returns true if BroadcastResults instances are equal
        /// </summary>
        /// <param name="input">Instance of BroadcastResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BroadcastResults input)
        {
            if (input == null)
                return false;
