...
namespace RadioManager.Model
{
        ...
        public partial class InlineResponse2006 :  IEquatable<InlineResponse2006>, IValidatableObject
    {
        ...
        public InlineResponse2006(long? currentPage = default(long?), long? from = default(long?), long? lastPage = default(long?), string nextPageUrl = default(string), string path = default(string), long? perPage = default(long?), string prevPageUrl = default(string), long? to = default(long?), long? total = default(long?), List<GenreResult> results = default(List<GenreResult>))
        {
