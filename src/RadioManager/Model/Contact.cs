...
namespace RadioManager.Model
{
    ...
    public partial class Contact :  IEquatable<Contact>, IValidatableObject
    {
        ...
        public Contact(long? ModelTypeId = default(long?), ContactFieldValues FieldValues = default(ContactFieldValues), string Email = default(string), string Firstname = default(string), string Lastname = default(string), string Phone = default(string))
        {
