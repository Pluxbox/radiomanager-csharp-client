...
namespace RadioManager.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PlaylistStructureBody :  IEquatable<PlaylistStructureBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlaylistStructureBody" /> class.
        /// </summary>
        /// <param name="start">start.</param>
        /// <param name="allowPlaylistPast">allowPlaylistPast.</param>
        /// <param name="broadcastId">broadcastId.</param>
        /// <param name="items">items.</param>
        public PlaylistStructureBody(DateTime? start = default(DateTime?), int? allowPlaylistPast = default(int?), long? broadcastId = default(long?), List<ImportItem> items = default(List<ImportItem>))
        {
            this.Start = start;
        ...
        {
            return this.Equals(input as PlaylistStructureBody);
        }

        /// <summary>
        /// Returns true if PlaylistStructureBody instances are equal
        /// </summary>
        /// <param name="input">Instance of PlaylistStructureBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlaylistStructureBody input)
        {
            if (input == null)
                return false;
