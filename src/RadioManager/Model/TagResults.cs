...
namespace RadioManager.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TagResults :  IEquatable<TagResults>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagResults" /> class.
        /// </summary>
        /// <param name="Results">Results.</param>
        public TagResults(List<TagResult> Results = default(List<TagResult>))
        {
        ...
        {
            return this.Equals(input as TagResults);
        }

        /// <summary>
        /// Returns true if TagResults instances are equal
        /// </summary>
        /// <param name="input">Instance of TagResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TagResults input)
        {
            if (input == null)
                return false;
