...
namespace RadioManager.Model
{
    ...
    public partial class BroadcastRelationsItems :  IEquatable<BroadcastRelationsItems>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BroadcastRelationsItems);
        }

        /// <summary>
        /// Returns true if BroadcastRelationsItems instances are equal
        /// </summary>
        /// <param name="other">Instance of BroadcastRelationsItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BroadcastRelationsItems other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
