...
namespace RadioManager.Model
{
    ...
    public partial class CampaignDataInput :  IEquatable<CampaignDataInput>, IValidatableObject
    {
        ...
        public CampaignDataInput(long? ModelTypeId = default(long?), List<Object> FieldValues = default(List<Object>), string Title = default(string), DateTime? Start = default(DateTime?), DateTime? Stop = default(DateTime?), bool? Recommended = default(bool?), string Description = default(string))
        {
