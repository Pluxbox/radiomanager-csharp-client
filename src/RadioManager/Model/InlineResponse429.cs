...
namespace RadioManager.Model
{
        ...
        public partial class InlineResponse429 :  IEquatable<InlineResponse429>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="error">Rate limit response.</param>
        /// <param name="statusCode">Corresponding HTTP Response Status Code.</param>
        public InlineResponse429(string error = default(string), long? statusCode = default(long?))
        {
            this.Error = error;
        ...
        /// Rate limit response
        /// </summary>
        /// <value>Rate limit response</value>
