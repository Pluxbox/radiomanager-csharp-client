...
namespace RadioManager.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BlockResults :  IEquatable<BlockResults>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BlockResults" /> class.
        /// </summary>
        ...
        public BlockResults(long? CurrentPage = default(long?), long? From = default(long?), long? LastPage = default(long?), string NextPageUrl = default(string), string Path = default(string), long? PerPage = default(long?), string PrevPageUrl = default(string), long? To = default(long?), long? Total = default(long?), List<BlockResult> Results = default(List<BlockResult>))
        {
        ...
        public List<BlockResult> Results { get; set; }
        ...
        {
            return this.Equals(input as BlockResults);
        }

        /// <summary>
        /// Returns true if BlockResults instances are equal
        /// </summary>
        /// <param name="input">Instance of BlockResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BlockResults input)
        {
            if (input == null)
                return false;
