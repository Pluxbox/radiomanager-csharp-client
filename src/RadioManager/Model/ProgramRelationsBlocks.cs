...
namespace RadioManager.Model
{
        ...
        public partial class ProgramRelationsBlocks :  IEquatable<ProgramRelationsBlocks>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ProgramRelationsBlocks);
        }

        /// <summary>
        /// Returns true if ProgramRelationsBlocks instances are equal
        /// </summary>
        /// <param name="input">Instance of ProgramRelationsBlocks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProgramRelationsBlocks input)
        {
            if (input == null)
                return false;
