...
namespace RadioManager.Model
{
    ...
    public partial class TagRelationsPrograms :  IEquatable<TagRelationsPrograms>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TagRelationsPrograms);
        }

        /// <summary>
        /// Returns true if TagRelationsPrograms instances are equal
        /// </summary>
        /// <param name="other">Instance of TagRelationsPrograms to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TagRelationsPrograms other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
