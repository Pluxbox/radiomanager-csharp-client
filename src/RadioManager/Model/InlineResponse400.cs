...
namespace RadioManager.Model
{
        ...
        public partial class InlineResponse400 :  IEquatable<InlineResponse400>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="error">Given error, names the problem..</param>
        /// <param name="errorDescription">Given error, describes the problem..</param>
        /// <param name="statusCode">Corresponding HTTP Response Status Code.</param>
        public InlineResponse400(string error = default(string), string errorDescription = default(string), int? statusCode = default(int?))
        {
            this.Error = error;
        ...
        /// </summary>
        /// <value>Given error, names the problem.</value>
