...
namespace RadioManager.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BroadcastOutputOnly :  IEquatable<BroadcastOutputOnly>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BroadcastOutputOnly" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BroadcastOutputOnly() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BroadcastOutputOnly" /> class.
        /// </summary>
        ...
        public BroadcastOutputOnly(long? Id = default(long?), DateTime? UpdatedAt = default(DateTime?), DateTime? CreatedAt = default(DateTime?), DateTime? DeletedAt = default(DateTime?), long? ExternalStationId = default(long?))
        {
            ...
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for BroadcastOutputOnly and cannot be null");
            }
            else
            {
                this.Id = Id;
        ...
        {
            return this.Equals(input as BroadcastOutputOnly);
        }

        /// <summary>
        /// Returns true if BroadcastOutputOnly instances are equal
        /// </summary>
        /// <param name="input">Instance of BroadcastOutputOnly to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BroadcastOutputOnly input)
        {
            if (input == null)
                return false;
