...
namespace RadioManager.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PlaylistTimingBody :  IEquatable<PlaylistTimingBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlaylistTimingBody" /> class.
        /// </summary>
        /// <param name="start">start.</param>
        /// <param name="allowPlaylistPast">allowPlaylistPast.</param>
        /// <param name="broadcastId">broadcastId.</param>
        /// <param name="items">items.</param>
        public PlaylistTimingBody(DateTime? start = default(DateTime?), int? allowPlaylistPast = default(int?), long? broadcastId = default(long?), List<ImportItem> items = default(List<ImportItem>))
        {
            this.Start = start;
        ...
        {
            return this.Equals(input as PlaylistTimingBody);
        }

        /// <summary>
        /// Returns true if PlaylistTimingBody instances are equal
        /// </summary>
        /// <param name="input">Instance of PlaylistTimingBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlaylistTimingBody input)
        {
            if (input == null)
                return false;
