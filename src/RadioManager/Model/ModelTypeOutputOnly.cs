...
namespace RadioManager.Model
{
    ...
    public partial class ModelTypeOutputOnly :  IEquatable<ModelTypeOutputOnly>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ModelTypeOutputOnly);
        }

        /// <summary>
        /// Returns true if ModelTypeOutputOnly instances are equal
        /// </summary>
        /// <param name="other">Instance of ModelTypeOutputOnly to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModelTypeOutputOnly other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
