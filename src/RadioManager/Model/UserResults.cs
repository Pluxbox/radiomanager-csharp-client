...
namespace RadioManager.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserResults :  IEquatable<UserResults>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserResults" /> class.
        /// </summary>
        ...
        public UserResults(long? CurrentPage = default(long?), long? From = default(long?), long? LastPage = default(long?), string NextPageUrl = default(string), string Path = default(string), long? PerPage = default(long?), string PrevPageUrl = default(string), long? To = default(long?), long? Total = default(long?), List<UserResult> Results = default(List<UserResult>))
        {
        ...
        {
            return this.Equals(input as UserResults);
        }

        /// <summary>
        /// Returns true if UserResults instances are equal
        /// </summary>
        /// <param name="input">Instance of UserResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserResults input)
        {
            if (input == null)
                return false;
