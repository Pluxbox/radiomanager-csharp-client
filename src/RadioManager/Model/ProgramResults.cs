...
namespace RadioManager.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProgramResults :  IEquatable<ProgramResults>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProgramResults" /> class.
        /// </summary>
        ...
        public ProgramResults(long? CurrentPage = default(long?), long? From = default(long?), long? LastPage = default(long?), string NextPageUrl = default(string), string Path = default(string), long? PerPage = default(long?), string PrevPageUrl = default(string), long? To = default(long?), long? Total = default(long?), List<ProgramResult> Results = default(List<ProgramResult>))
        {
        ...
        public List<ProgramResult> Results { get; set; }
        ...
        {
            return this.Equals(input as ProgramResults);
        }

        /// <summary>
        /// Returns true if ProgramResults instances are equal
        /// </summary>
        /// <param name="input">Instance of ProgramResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProgramResults input)
        {
            if (input == null)
                return false;
