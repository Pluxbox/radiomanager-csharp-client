...
namespace RadioManager.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PresenterResults :  IEquatable<PresenterResults>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PresenterResults" /> class.
        /// </summary>
        ...
        public PresenterResults(long? CurrentPage = default(long?), long? From = default(long?), long? LastPage = default(long?), string NextPageUrl = default(string), string Path = default(string), long? PerPage = default(long?), string PrevPageUrl = default(string), long? To = default(long?), long? Total = default(long?), List<PresenterResult> Results = default(List<PresenterResult>))
        {
        ...
        public List<PresenterResult> Results { get; set; }
        ...
        {
            return this.Equals(input as PresenterResults);
        }

        /// <summary>
        /// Returns true if PresenterResults instances are equal
        /// </summary>
        /// <param name="input">Instance of PresenterResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PresenterResults input)
        {
            if (input == null)
                return false;
