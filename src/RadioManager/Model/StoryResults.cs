...
namespace RadioManager.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StoryResults :  IEquatable<StoryResults>, IValidatableObject
    {
        /// <summary>
        ...
        public StoryResults(long? CurrentPage = default(long?), long? From = default(long?), long? LastPage = default(long?), string NextPageUrl = default(string), string Path = default(string), long? PerPage = default(long?), string PrevPageUrl = default(string), long? To = default(long?), long? Total = default(long?), List<StoryResult> Results = default(List<StoryResult>))
        {
        ...
        public List<StoryResult> Results { get; set; }
        ...
        {
            return this.Equals(input as StoryResults);
        }

        /// <summary>
        /// Returns true if StoryResults instances are equal
        /// </summary>
        /// <param name="input">Instance of StoryResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoryResults input)
        {
            if (input == null)
                return false;
